...
(function() { this.JST || (this.JST = {}); this.JST["public/templates/home/home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="home-panel">\n  <div class="panel-heading text-right">\n\n  </div>\n  <div class="panel-body container-fluid">\n    <div class="row row-lg">\n      <div class="col-xs-12">\n        <div class="image-wrap">\n          <div class="row">\n            <div class="col-xs-12">\n              <div class="js-word-wrap">\n\n\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\'clear\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/kanji/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div style="background: #FFFEFB;" class="panel">\n  <div class="panel-body">\n    ');  _.each(kanjis, function(kanji, index) { ; __p.push('\n      <ruby style=\'padding-right: 5px;\'>\n        <rb style=\'font-size: 20px;\'>\n          <a href="#',  kanji.id ,'">',  kanji.name ,'</a>\n        </rb>\n        <rp>/</rp>\n        <rt style=\'font-size: 14px;\'>',  kanji.romaji ,'</rt>\n      </ruby>\n    ');  }) ; __p.push('\n    ');  _.each(kanjis, function(kanji, index) { ; __p.push('\n      <div id="',  kanji.id ,'" class=\'row\' style=\'margin-bottom: 10px;\'>\n        <div class=\'col-sm-1\'>\n          <ruby>\n            <rb>\n              <a href="#',  kanji.id ,'" style=\'font-size: 50px; font-weight: bold; text-decoration: none;\'> ',  kanji.name ,' </a>\n            </rb>\n            <rp>/</rp>\n            <rt style=\'font-size: 18px; font-weight: bold; color: black; text-transform: uppercase;\'>\n              ',  kanji.romaji ,'\n            </rt>\n          </ruby>\n        </div>\n        <div class=\'col-sm-1\'>\n          <img src="',  kanji.image ,'" height="100" width="100">\n        </div>\n        <div class=\'col-sm-3\'>\n          <div class=\'js-explain\' data-id="',  kanji.id ,'"  style="word-wrap: break-word; font-size: 15px; color: black; border-bottom: none;">\n            ',  kanji.explain ,'\n          </div>\n        </div>\n        <div class=\'col-sm-5\'>\n          <p><span>On: </span> <span style=\'font-weight: bold; color: black;\'>',  kanji.onyomi ,'</span></p>\n          <p><span>Kun: </span> <span style=\'font-weight: bold; color: black;\'>',  kanji.kunjomi ,'</span></p>\n          <p style=\'border-bottom: 1px solid;\'>\n            Radical: ',  kanji.radical ,'  Stroke: ',  kanji.stroke ,'  Elements: ',  kanji.elements ,'\n          </p>\n        </div>\n        <div class=\'col-sm-2\'>\n          <p><span>-  </span><span style=\'font-weight: bold; color: black;\'>',  kanji.mean ,'</span></p>\n          <p><span>-  </span><span style=\'font-weight: bold; color: black;\'>',  kanji.vn_mean ,'</span></p>\n        </div>\n      </div>\n    ');  }) ; __p.push('\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/kanji/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/kanji/write"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel">\n  <div class="panel-body">\n    <div class=\'\' style="margin-bottom: 10px;">\n      ');  _.each(kanjis, function(kanji, index) { ; __p.push('\n        <ruby style=\'padding-right: 5px;\'>\n          <rb style=\'font-size: 20px;\'>\n            <a href="" data-id="', kanji.id,'" class=\'js-click\'>',  kanji.name ,'</a>\n          </rb>\n          <rp>/</rp>\n          <rt style=\'font-size: 14px;\'>',  kanji.romaji ,'</rt>\n        </ruby>\n      ');  }) ; __p.push('\n    </div>\n    <div class=\'row\'>\n      <div class=\'col-sm-4\'>\n        <button type="button" class="js-easer btn btn-floating btn-success easer-btn"><i class="icon wb-pencil" aria-hidden="true"></i></button>\n        <h5 class=\'js-x\' data-kind=\'explain\'>\n          ',  kanjis[0].explain ,'\n        </h5>\n        <p class=\'js-x\' style=\'color: black;\' data-kind=\'mean\'>\n          ',  kanjis[0].mean ,'\n        </p>\n        <p class=\'js-x\' style=\'color: black;\' data-kind=\'vn_mean\'>\n          ',  kanjis[0].vn_mean ,'\n        </p>\n        <table class=\'table-example js-x\' data-kind=\'example_tb\'>\n          ',  kanjis[0].example_tb ,'\n        </table>\n      </div>\n      <div class=\'col-sm-8\'>\n        <div class=\'row\'>\n          <div class=\'col-sm-3\'>\n            <div class=\'image-kanji\'>\n              <ruby>\n                <rb>\n                  <img class=\'js-x\' data-kind=\'image\' src="',  kanjis[0].image ,'" height="80" width="80">\n                </rb>\n                <rp>/</rp>\n                <rt class=\'js-x p-bold p-romanji\' data-kind=\'romaji\'>',  kanjis[0].romaji ,'</rt>\n              </ruby>\n            </div>\n            <div>\n              <p><span>On: </span> <span class=\'js-x p-bold\' data-kind=\'onyomi\'>',  kanjis[0].onyomi ,'</span></p>\n                <p><span>Kun: </span> <span class=\'js-x p-bold\' data-kind=\'kunjomi\'>',  kanjis[0].kunjomi ,'</span></p>\n                <p>\n                  Radical: <span class=\'js-x\' data-kind=\'radical\'>',  kanjis[0].radical ,'</span>  Stroke: <span class=\'js-x\' data-kind=\'stroke\'>',  kanjis[0].stroke ,'</span>  Elements: <span class=\'js-x\' data-kind=\'elements\'> ',  kanjis[0].elements ,' </span>\n                </p>\n            </div>\n          </div>\n          <div class=\'col-sm-9\'>\n            <div id=\'simple-board\' class=\'write-board\'></div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/radical/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="home-panel">\n  <div class="panel-heading text-right">\n\n  </div>\n  <div class="panel-body container-fluid">\n    <div class="row row-lg">\n      <div class="col-xs-12">\n        <div class="image-wrap">\n          <div class="row">\n            <div class="col-xs-12">\n              <div class="js-radical-wrap">\n\n\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\'clear\'></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/radical/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel">\n  <div class="panel-body">\n    <div class=\'row\'>\n      <h1 class="page-title js-name" style="text-align:center; font-size: 200px;">',  radical.name ,'</h1>\n      <h1 class="page-title js-name" style="text-align:center">',  radical.china ,'</h1>\n      <h3 class="page-title" style="text-align:center">',  radical.mean ,'</h3>\n      <div class="col-sm-4">\n\n      </div>\n      <div class="form-group col-sm-4">\n        <input type="text" class="form-control input-lg js-input" style="text-align: center" placeholder="',  radical.name ,'">\n      </div>\n      <div class="col-sm-4">\n        <h4 class="page-title js-times" style="\n          height: 50px;\n          width: 50px;\n          border-radius: 50%;\n          border: 1px solid;\n          text-align: center;\n          padding: 13px;">\n            ',  radical.times || 0 ,'\n        </h4>\n      </div>\n      <div class="form-group col-sm-12">\n        <button type="button" class="btn btn-primary"> Back </button>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/word/edit"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="page-content">\n  <div class="panel">\n    <div class="panel-body container-fluid">\n      <div class="row row-lg">\n        <div class="col-sm-6">\n          <div class="word-wrap">\n            <h4 class="word-title">Basic Form Without Label</h4>\n            <div class="word">\n              <form class="js-form">\n                <div class="row">\n                  <div class="form-group col-sm-6">\n                    <input type="text" class="form-control" name="name" placeholder="Name" autocomplete="off">\n                  </div>\n                  <div class="form-group col-sm-6">\n                    <input type="text" class="form-control" name="name_jp" placeholder="Name JP" autocomplete="off">\n                  </div>\n                </div>\n                <!-- <div class="form-group">\n                  <div class="radio-custom radio-default radio-inline">\n                    <input type="radio" id="inputLabelMale" name="inputRadioGender">\n                    <label for="inputLabelMale">Male</label>\n                  </div>\n                  <div class="radio-custom radio-default radio-inline">\n                    <input type="radio" id="inputLabelFemale" name="inputRadioGender" checked="">\n                    <label for="inputLabelFemale">Female</label>\n                  </div>\n                </div> -->\n                <div class=\'row\'>\n                  <div class="form-group col-sm-6">\n                    <input type="text" class="form-control" name="mean" placeholder="Means" autocomplete="off">\n                  </div>\n                  <div class="form-group col-sm-6">\n                    <input type="text" class="form-control" name="lesson" placeholder="Lesson" autocomplete="off">\n                  </div>\n                </div>\n\n                <div class="form-group">\n                  <button type="submit" class="btn btn-primary js-submit">Submit</button>\n                </div>\n              </form>\n            </div>\n          </div>\n        </div>\n\n        <div class="clearfix hidden-xs"></div>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["public/templates/word/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="panel">\n  <div class="panel-body">\n    <div class=\'row\'>\n      <div class="col-sm-4">\n        <h1 class="page-title js-name">',  word.name ,'</h1>\n        <h3 class="page-title js-kanji-note">',  word.kanji_note ,'</h3>\n      </div>\n      <div class="form-group col-sm-4">\n        <h4 class="page-title js-mean">',  word.mean ,'</h4>\n        <input type="text" class="form-control input-lg js-input" style="text-align: center" placeholder="',  word.name.replace(/～/g, '') ,'">\n      </div>\n      <div class="col-sm-4">\n\n        <div class=\'js-kanji\'>\n          ',  word.name_jp.replace(/～/g, '') ,'\n        </div>\n        <h2 class="page-title js-romanji">',  word.romanji.replace(/～/g, '') ,'</h2>\n        <h4 class="page-title js-times" style="\n          height: 50px;\n          width: 50px;\n          border-radius: 50%;\n          border: 1px solid;\n          text-align: center;\n          padding: 13px;">\n            ',  word.times || 0 ,'\n        </h4>\n      </div>\n      <div class="form-group col-sm-12">\n        <div class=\'js-hint\'>',(''+ word.hint ).replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;').replace(/"/g, '&quot;').replace(/'/g, '&#x27;').replace(/\//g,'&#x2F;'),'</div>\n      </div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
/*
...
JP.Globals.assetsPath = '/assets' + '/';
JP.Globals.Assets = {};
JP.Assets = JP.Globals.Assets;
JP.Globals.env = 'development';
...
$(function() {
  ...
  JP.Controllers.EventsController = Backbone.View.extend({
  ...
  JP.events = new JP.Controllers.EventsController();
